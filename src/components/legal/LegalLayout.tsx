    ...
    <div className="landing-shell relative min-h-screen overflow-x-clip pb-8">
      ...
      <main id="legal-content" className="relative z-10 pb-10">
        <section className="relative px-4 pt-11 pb-8 sm:px-6 md:pt-16">
          <div className="mx-auto flex max-w-4xl xl:max-w-6xl flex-col gap-6">
            <nav
            ...
            <div className="landing-fade-up space-y-5">
              ...
              <h1 className="text-balance font-[family-name:var(--font-syne)] text-[2rem] leading-[1.05] font-bold tracking-tight text-foreground sm:text-[2.6rem] md:text-[3rem]">
              ...
              <p className="text-[0.72rem] uppercase tracking-[0.13em] text-muted-foreground">
  ...
  return (
    <section id={id} className="scroll-mt-24 py-6">
      <div className="flex items-baseline gap-3">
        <span className="font-[family-name:var(--font-sora)] text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
          {String(index).padStart(2, "0")}
        </span>
        <h2 className="font-[family-name:var(--font-syne)] text-xl font-semibold tracking-tight text-foreground sm:text-2xl">
          {title}
        </h2>
      </div>
      <div className="prose-legal mt-3 space-y-3 text-sm leading-relaxed text-muted-foreground sm:text-[0.95rem]">
        {children}
      </div>
    </section>
  );
