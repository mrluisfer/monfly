...
export const TrialAlert = () => {
  return (
    <div className="rounded-[1.5rem] border border-border/70 bg-[linear-gradient(120deg,rgba(20,184,166,0.12),rgba(59,130,246,0.08),rgba(255,255,255,0.45))] px-5 py-8 sm:px-8 sm:py-10">
