...
export const FooterNavigation = () => (
  <div className="grid gap-8 md:grid-cols-[240px_1fr] md:items-start">
    ...
    <div className="grid grid-cols-2 gap-6 text-muted-foreground text-sm sm:flex sm:justify-between sm:gap-8">
              ...
              {link.items.map((item) => (
                <li key={item.label}>
                  <Button
                    variant="link"
                    size="lg"
                    className="h-auto justify-start px-0 py-0 text-muted-foreground text-xs no-underline hover:text-foreground hover:no-underline"
